...
function Models(props: any) {
  ...
  const models = [
    { id: 'highestFantasyPoints', label: 'Highest Fantasy Points', icon: '/trophy.svg' },
    { id: 'highestCeiling', label: 'Highest Ceiling', icon: '/fire.svg' },
    { id: 'highestFloor', label: 'Highest Floor', icon: '/floor.svg' },
    { id: 'highestPopularity', label: 'Highest Popularity', icon: '/popularity.svg' },
  ];

  return (
    <div className={`flex flex-col w-full h-full justify-center rounded-3xl align-middle border-white bg-[#2E1919] border-[1px] border-opacity-5 ${classname}`}>
      <div className='w-full font-bold text-4xl text-center pb-3 mt-3'>Models</div>
