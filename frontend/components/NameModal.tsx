...
const Match: React.FC<MatchProps> = ({
  ...
  time,
    ...
    const names = ['Dream Team', 'Niggas in Paris', 'sjvbkhsnvsv', 'helloWorld']
            ...
            <div className="flex w-full justify-between mt-4">
              <div className="flex flex-col w-full justify-center">
                <div className="w-full flex flex-col gap-10 items-center">
                    <input type="text" className=" min-h-[40%] w-[70%] rounded-xl bg-[#464646] px-3 outline-none" placeholder={teamName} onChange={(e)=>{
                    ...
                    <div className='flex w-full justify-center gap-5'>
                        ...
                        onClick={() => {
                            setTeamName(names[Math.floor(Math.random() * 4)])
                        }}
                    >
                        Recommend
                        </Button>
